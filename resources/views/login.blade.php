...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        ...
        <div class="p-4 mt-6 text-sm text-yellow-800 bg-yellow-100 border border-yellow-400 rounded-md" role="alert">
            ...
            <p class="mt-2">Bluelogへのログインには、Blueskyのメインパスワードではなく、<strong class="font-semibold">アプリパスワード</strong>のご利用を強く推奨します。アプリパスワードは、特定のアプリケーションにのみアクセスを許可する使い捨てのパスワードであり、万が一漏洩した場合でもメインアカウントのセキュリティリスクを最小限に抑えることができます。</p>
            <p class="mt-2">アプリパスワードの発行方法や、その安全性に関する詳細は、<a href="#" class="font-medium text-yellow-900 underline hover:text-yellow-700">よくある質問（FAQ）ページ</a>をご確認ください。</p>
        </div>
    </div>
</div>
@endsection
